<nav class="navbar navbar-expand-lg bg-navbar">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?= BASE_URL ?>"><img src="<?= BASE_URL ?>/assets/images/viajes.png"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (isset($_SESSION['usuario']) && in_array('CLIENTE', $_SESSION['usuario']['roles'])) { ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/usuarios/indexClientes">Clientes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/viajes/misViajes">Mis viajes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/viajes-clientes">Contrata</a>
                    </li>
                <?php } ?>
                <?php if (isset($_SESSION['usuario']) && in_array('EMPLE', $_SESSION['usuario']['roles'])) { ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/viajes/viajesAsignados">Mis viajes</a>
                    </li>
                <?php } ?>
                <?php if (isset($_SESSION['usuario']) && in_array('EMPLE', $_SESSION['usuario']['roles'])) { ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/usuarios/indexEmple">Empleados</a>
                    </li>
                <?php } ?>
                <?php if (isset($_SESSION['usuario']) && in_array('ADMIN', $_SESSION['usuario']['roles'])) { ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/admin">Administracion</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/viajes-clientes">Viajes-Clientes</a>
                    </li>
                <?php } ?>
            ...
            <?php if (!isset($_SESSION['usuario'])) { ?>
                <button class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#modalLogin">Entrar
                </button>
            ...
            <?php } else { ?>
                ...
                <form class="d-flex" role="search">
                    <button class="btn btn-outline-dark" type="submit"><a href="<?= BASE_URL ?>/login/out"
