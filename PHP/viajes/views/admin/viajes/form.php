<input type="hidden" name="id" value="<?= isset($data['viaje']['id']) ? $data['viaje']['id'] : '' ?>">
<div class="card m-2">
        ...
        <div class="row mb-3">
            <div class="col-12 col-md-6 form-floating">
                <input type="text" class="form-control" id="codigo" name="codigo"
                       placeholder="Introduce el código" value="<?= $data['viaje']['codigo'] ?? '' ?>">
                <label for="codigo">Código</label>
            </div>
            <div class="col-12 col-md-6 form-floating">
                <input type="text" class="form-control" id="titulo" name="titulo"
                       placeholder="Introduce el título" value="<?= $data['viaje']['titulo'] ?? '' ?>">
        ...
        <div class="row mb-3">
            <div class="col-12 col-md-6 form-floating">
                <input type="number" class="form-control" id="numParticipantes" name="numParticipantes"
                       ...
                       value="<?= $data['viaje']['num_participantes'] ?? '' ?>">
        ...
        <div class="row mb-3">
            <div class="col-12 col-md-6 form-floating">
                <input type="date" class="form-control" id="llegada" name="llegada"
                       placeholder="Fecha de llegada" value="<?= $data['viaje']['llegada'] ?? '' ?>">
                <label for="llegada">Fecha de Llegada</label>
            </div>
            <div class="col-12 col-md-6 form-floating">
                <input type="number" class="form-control" id="precio" name="precio"
                       placeholder="Introduce el precio" value="<?= $data['viaje']['precio'] ?? '' ?>">
