...
@WebServlet(name = "nuevoViajeClienteServlet", value = "/viajes-clientes/nuevos")
public class NuevoViajeClienteServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        request.getRequestDispatcher("/viajeCliente/nuevo.jsp").forward(request, response);
    }

    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ViajeCliente viajeCliente = ViajeClienteService.formToEntity(request);

        if(viajeClienteDao.add(viajeCliente)!=null){
            request.setAttribute("mensaje", "Viaje Cliente añadido correctamente");
            viajesClientes = viajeClienteDao.findAll();
        }else {
            request.setAttribute("mensaje", "Viaje cliente no añadido");
        }
